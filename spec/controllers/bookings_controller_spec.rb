...
RSpec.describe BookingsController, type: :controller do
	context 'Success' do
	  ...
	  context 'GET show' do
		...
		context 'PUT update' do
			it 'should be a valid booking updation' do
				booking = FactoryGirl.create(:booking)
		...
		context 'DELETE destroy' do
			it 'should be a valid booking deletion' do
				booking = FactoryGirl.create(:booking)
	...
	context'Failure' do
		...
		context 'PUT update' do
			...
			it 'should not be a valid booking updation with invalid viewer id' do
				booking = FactoryGirl.create(:booking)
		...
		context 'DELETE destroy' do
			it 'should not be a valid booking deletion with invalid id' do
				booking = FactoryGirl.create(:booking)
