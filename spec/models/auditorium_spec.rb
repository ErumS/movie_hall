...
RSpec.describe Auditorium, type: :model do
    ...
    context 'Success' do
  		it 'should be a valid auditorium' do
    ...
    context 'Failure' do
    	it 'should not be a valid auditorium' do
  ...
  context 'Associations' do
    ...
    context 'Failure' do
      ...
      it 'should not have many viewers' do
        ...
        auditorium.viewers.should_not include viewer1
        auditorium.viewers.should_not include viewer2 
      end
      it 'should not have many bookings' do
        auditorium = FactoryGirl.create(:auditorium)
        booking1 = FactoryGirl.create(:booking)
        booking2 = FactoryGirl.create(:booking)
        auditorium.bookings.should_not include booking1
        auditorium.bookings.should_not include booking2    
      end
      it 'should not have many seats' do
        ...
        auditorium.seats.should_not include seat1
        auditorium.seats.should_not include seat2
        auditorium.seats.should_not include seat3
      end
    end
  end
end